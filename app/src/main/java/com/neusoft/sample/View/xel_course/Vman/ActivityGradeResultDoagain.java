...
import com.neusoft.sample.View.xel_course.Activity_report_wrong;
 ...
 */
public class ActivityGradeResultDoagain extends BaseActivity {
    ...
    AlwaysMarqueeTextView titlenofull;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if(QuestionnumberSwitchTitle.Gettitle(xtcsjg.getTest_group_number()).contains("背单词")){
            ...
            titlenofull.setText(QuestionnumberSwitchTitle.GetErrortitle(xtcsjg.getTest_group_number())+""
            );
        }
        ...
        * */
        ...
        for (TextOneStructure textOneStructure : textOneStructureList) {
            ...
            {
                if (!group_number.substring(0, 1).equals("5"))
        ...
        for (TextTwoStructure textTwoStructure : textTwoStructureList) {
            if (group_number.substring(0, 9).equals(textTwoStructure.getSectionNo()))
            {
                ...
                if (group_number.substring(0,1).equals("C")||group_number.substring(0,1).equals("5")||group_number.substring(0,1).equals("8"))
                {
                    tv_full_jie.setVisibility(View.GONE);
                }
                else {
                    tv_full_jie.setVisibility(View.VISIBLE);
    ...
    private void Initview_taozhuan() {
        ...
        do_wrong.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent_doagin = new Intent(ActivityGradeResultDoagain.this, Activity_report_wrong.class);
