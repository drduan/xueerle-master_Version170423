...
public class Math_framents_for_homeWork extends Fragment  implements DatePickerDialog.OnDateSetListener{
                ...
                try {
                    ...
                    if (jsonObject.get("success").equals("200")) {
                        ...
                        for (int i = 0; i < jsonArray.length(); i++) {
                            ...
                            if ("数学".equals(dataitem.getString("subject"))) {
...
//                                    stringList.add(homeWork_entity.getWorkname() + "   发布人:" + dataitem.get("jobperson"));
    ...
    public Math_framents_for_homeWork() {
    }
     ...
     *
     */
    public static Math_framents_for_homeWork newInstance() {
        Math_framents_for_homeWork fragment = new Math_framents_for_homeWork();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_my_home_work_math, container, false);
      listView = (ListView) rootView.findViewById(R.id.homework_list_math);
        ...
        time_work.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Log.d("DatePickerDialog",year+"nian"+month+"yue"+day+"ri");
                dlg = new DatePickerDialog(getContext(), Math_framents_for_homeWork.this, year, month, day);
                dlg.show();
    ...
    public void onDateSet(DatePicker view, int year, int monthOfYear, int dayOfMonth) {
        Log.d("DatePickerDialogp",year+"nian"+monthOfYear+"yue"+dayOfMonth+"ri");
