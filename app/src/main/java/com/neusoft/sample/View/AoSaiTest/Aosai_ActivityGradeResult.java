 ...
 */
public class Aosai_ActivityGradeResult extends BaseActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if(QuestionnumberSwitchTitle.Gettitle(xtcsjg.getTest_group_number()).contains("背单词")){
            ...
            titlenofull.setText(QuestionnumberSwitchTitle.Gettitle(xtcsjg.getTest_group_number()) + ">第"
                    + group_number.substring(9, 11) + "组");
        }

        lists_report.setText("奥赛测试成绩报告单");
        if ("doagain".equals(MsharedPrefrence.GetisDoGain(this))) {

            lists_report.setText("奥赛测试错题重做报告单");
        }
    ...
    private void Initview_taozhuan() {
        do_agin.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent_doagin = new Intent(Aosai_ActivityGradeResult.this, BottomTabSwitcherActivity.class);
        ...
        @Override
        public void onClick(View v) {
            Intent intent_doagin = new Intent(Aosai_ActivityGradeResult.this, Aosai_Activity_report_wrong.class);
            intent_doagin.putParcelableArrayListExtra("list", (ArrayList<? extends Parcelable>) list);
