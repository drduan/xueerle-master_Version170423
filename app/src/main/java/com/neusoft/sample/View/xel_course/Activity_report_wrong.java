 ...
 */
public class Activity_report_wrong extends BaseActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if ("doagain".equals(MsharedPrefrence.GetisDoGain(Activity_report_wrong.this))) {
        ...
        again_do.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                //加载试题
                MsharedPrefrence.SetisDoGain(Activity_report_wrong.this);
               Log.d("我要重新开始做了","successfully");
                startActivity(new Intent(Activity_report_wrong.this, DoEaxm.class).putExtra("error_q", "1").putExtra("nub_zu",xtctjlList.get(0).getXtdctm_id()));
                finish();
            }
        });
    }
    private class RwArrayAdapter extends BaseAdapter{
        ...
        public synchronized View getView(int position, View convertView, ViewGroup parent) {
            ...
            String Mychoice="";
            List<CalculationTest> testList= Db_CaculationTest.getInstance(Activity_report_wrong.this).loadAllNote();
            for (CalculationTest test:testList) {
            ...
            //利用Java反射，通过用户选择的ABCD获取其实体的属性名称，进而获取其属性的内容
            for (CalculationTest calculationTest:caculationTests)
            {
