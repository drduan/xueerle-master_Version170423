...
public class English_framents_for_homeWork extends Fragment  implements DatePickerDialog.OnDateSetListener{
                ...
                try {
                    ...
                    if (jsonObject.get("success").equals("200")) {
                        ...
                        for (int i = 0; i < jsonArray.length(); i++) {
                            ...
                            if ("英语".equals(dataitem.getString("subject"))) {
...
//                                    stringList.add(homeWork_entity.getWorkname() + "   发布人:" + dataitem.get("jobperson"));
    ...
    public English_framents_for_homeWork() {
    }
    ...
    public static English_framents_for_homeWork newInstance() {
        English_framents_for_homeWork fragment = new English_framents_for_homeWork();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_my_home_work_english, container, false);
        listView = (ListView) rootView.findViewById(R.id.homework_list_english);
        ...
        time_work.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                dlg = new DatePickerDialog(getContext(), English_framents_for_homeWork.this, year, month, day);
                dlg.show();
                ...
                try {
                    ...
                    for (int i = 0; i < jsonArray.length(); i++) {
                        ...
                        if ("英语".equals(dataitem.getString("subject"))) {
                            ...
                            data1=dataitem.getString("date1");
                            Log.d("dataString英语", JSON.toJSONString(stringList));
