 ...
 */
public class Aosai_ActivityGrade_full_Result extends BaseActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if(QuestionnumberSwitchTitle.Gettitle(xtcsjg.getTest_group_number()).contains("背单词")){
            ...
            titlefull.setText(QuestionnumberSwitchTitle.Gettitle(xtcsjg.getTest_group_number())
                    + ">第" + group_number.substring(9, 11) + "组");
        }
        ...
        * 获取章节列表
        * */
        tv_full_report.setText("奥赛测试成绩报告单");
       ...
       // tv_full_jie.setText(""+"第"+ group_number.substring(7, 9)+"节 ");
        ...
        int time = 0;
        String IsDoSubject = "";
        for (XTCSGJ xtcsgj : xtcsgjList) {
            GJ = xtcsgj.getIsGJ();
            time = xtcsgj.getTime();
            IsDoSubject = xtcsgj.getIsDoSubject();
        }
        ...
        if((GJ.equals("no"))){
//            if(((xtcsjg.getDuration()-time)/1000)<=0){
//                tv_cha.setVisibility(View.GONE);
//                tv_cha_miao.setVisibility(View.GONE);
//                chatime_full.setText(" ");
//            }
//            else {
...
//            }
        ...
        if (!"".equals(nextzu)) {
            nextquestion.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    Intent intent = new Intent(Aosai_ActivityGrade_full_Result.this, SecondActivity.class);
            ...
            nextquestion.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    Toast.makeText(Aosai_ActivityGrade_full_Result.this, "恭喜您！本节题目已经全部做完！", Toast.LENGTH_SHORT).show();
                }
            });
        }
        if ("no".equals(IsDoSubject)) {
            ...
            againchallenge.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    startActivity(new Intent(Aosai_ActivityGrade_full_Result.this, Aosai_DoEaxm.class).putExtra("nub_zu",group_number));
                    finish();
                }
            });
        }
