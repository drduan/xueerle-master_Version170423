 ...
 */
public class Xel_learntrack_chinese_Fragment extends Fragment {
    private final static String TAG = "Learn_track-Chinese";

    private List<Map<Object, String>> date = dateSet;
    private List<Map<Object, String>> type = new Xel_learntrack_dataHandler().getSuitableSubjectList("chinese");
    ...
    private String detailTitle = "语文>学习轨迹>";

    public Xel_learntrack_chinese_Fragment() {
        // Required empty public constructor
    }

    public static Xel_learntrack_chinese_Fragment newInstance(int instance) {
        Bundle args = new Bundle();
        args.putInt(ARGS_INSTANCE, instance);
        Xel_learntrack_chinese_Fragment fragment = new Xel_learntrack_chinese_Fragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.xel_learntrack_chinese_fragment, container, false);
        initView(v);
        initData();
        return v;
    }
    ...
    private void initData() {
        ...
        go.setOnClickListener(new Xel_learntrack_chinese_Fragment.pushInfosToPostThread());
    }
