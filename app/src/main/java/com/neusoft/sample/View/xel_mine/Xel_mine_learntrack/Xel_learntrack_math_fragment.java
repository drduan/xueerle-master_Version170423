 ...
 */
public class Xel_learntrack_math_fragment extends Fragment {
    private final static String TAG = "Learn_track-Math";

    private List<Map<Object, String>> date = dateSet;
    private List<Map<Object, String>> type = new Xel_learntrack_dataHandler().getSuitableSubjectList("math");
    ...
    private String detailTitle = "数学>学习轨迹>";

    public Xel_learntrack_math_fragment() {
        // Required empty public constructor
    }

    public static Xel_learntrack_math_fragment newInstance(int instance) {
        Bundle args = new Bundle();
        args.putInt(ARGS_INSTANCE, instance);
        Xel_learntrack_math_fragment fragment = new Xel_learntrack_math_fragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.xel_learntrack_math_fragment, container, false);
        Log.d(TAG, "DATA:" + date.toString());
    ...
    private void initData() {
        ...
        go.setOnClickListener(new pushInfosToPostThread());
    }
        ...
        public void onClick(View v) {
            ...
            new Thread(new Runnable() {
                ...
                public void run() {
                    ...
                    String[] selectedDate1 = getDateString();
                    detailTitle = "数学>学习轨迹>";
                    detailTitle = detailTitle + selectedDate1[year_month.getSelectedItemPosition()]+">"+type.get(testType.getSelectedItemPosition()).get("name");
